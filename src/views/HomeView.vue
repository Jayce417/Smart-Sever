<template>
    <div class="decision-tree-container">
            ...
            <el-header height="60px">
                <div class="header-content">
                    ...
                    <div class="header-controls">
                        <!-- <el-select v-model="$i18n.locale" size="small" class="language-selector">
                ...
                <el-row :gutter="20">
                        ...
                        <el-card class="control-panel" shadow="hover">
                            <template #header>
                                <div class="card-header">
                                    ...
                                    <el-button type="primary" size="small" @click="showCreateNodeDialog = true">
                                        <el-icon>
                                            <Plus />
                                        </el-icon>
                                        {{ $t("home.createNode") }}
                            ...
                            <div class="node-list">
                                ...
                                <el-table :data="nodes" style="width: 100%" :header-cell-style="{
                                    background: '#f5f7fa',
                                    color: '#606266',
                                }" stripe size="small">
                                    <el-table-column prop="name" :label="$t('home.nodeName')" />
                                    <el-table-column prop="type" :label="$t('home.type')" width="120">
                                        <template #default="scope">
                                            <el-tag :type="isDefaultEndNode(
                                                scope.row.name,
                                            )
                                                ? 'info'
                                                : getNodeTypeColor(
                            ...
                            <div class="visualization-controls" style="margin-top: 20px">
                                <div class="control-section">
                                    ...
                                    <div class="button-group">
                                        <el-button type="info" size="small" @click="loadExample">
                                            <el-icon>
                                                <Document />
                                            </el-icon>
                                            {{ $t("home.loadExample") }}
                                        </el-button>
                                        <el-button type="info" size="small" @click="loadExample2">
                                            <el-icon>
                                                <Document />
                                            </el-icon>
                                            Example 2
                                ...
                                <div class="control-section">
                                    ...
                                    <div class="button-group">
                                        <el-button type="danger" size="small" @click="generateTree"
                                            :disabled="nodes.length === 0">
                                            <el-icon>
                                                <Share />
                                            </el-icon>
                            ...
                            <div class="payoff-config" style="margin-top: 20px">
                                ...
                                <div class="code-editor-container">
                                    <el-input v-model="payoffFunction" type="textarea" :rows="12" class="code-editor"
                                        :placeholder="$t('home.enterPayoffFunction')
                                            " />
                                </div>
                            ...
                            <div class="payoff-config" style="margin-top: 20px">
                                ...
                                <div style="margin-bottom: 15px">
                                    <label style="
                                            ...
                                            font-weight: 500;
                                        ">Method:</label>
                                    <el-select v-model="payoffConfig.method" style="width: 100%">
                                        <el-option label="Expected Value (EV)" value="ev" />
                                        <el-option label="Certainty Equivalent (CE)" value="ce" />
                                        <el-option label="Expected Utility (EU)" value="eu" />
                                    </el-select>
                                </div>
                                ...
                                <div style="margin-bottom: 15px">
                                    ...
                                    <el-select v-model="payoffConfig.utility_fn" style="width: 100%">
                                        <el-option label="None (Expected Utility)" value="None" />
                                        <el-option label="Exponential Utility Function" value="exp" />
                                        <el-option label="Logarithmic Utility Function" value="log" />
                                    </el-select>
                                </div>
                                ...
                                <div style="margin-bottom: 15px">
                                    ...
                                    <el-input-number v-model="payoffConfig.risk_tolerance" :step="0.1" :precision="2"
                                        style="width: 100%" />
                                </div>
                            </div>
                        </el-card>
                    ...
                    <el-col :span="16">
                        <el-card class="visualization-area" shadow="hover">
                            <template #header>
                                <div class="card-header">
                                    ...
                                    <div class="interaction-controls">
                                        ...
                                        <el-button size="small" @click="showPreviewDialog = true"
                                            :disabled="nodes.length === 0">
                                            <el-icon>
                                                <View />
                                            </el-icon>
                            ...
                            <!-- 敏感性分析结果区域 -->
                            <div v-if="sensitivityAnalysisResult" class="sensitivity-analysis-section">
                                ...
                                <div class="sensitivity-results">
                                    <div class="result-content">
                                        ...
                                        <div class="result-image">
                                            <img :src="sensitivityAnalysisResult.file_url
                                                " :alt="$t(
                                                    'home.sensitivityAnalysisChart',
                                                )
                                                    " @error="handleImageError" class="sensitivity-chart" />
                                        </div>
                                        <div class="result-actions">
                                            ...
                                            <el-button size="small" @click="clearSensitivityResults">
                                                {{ $t("home.clearResults") }}
                                            </el-button>
                                        </div>
                                    </div>
                    ...
                    <el-form-item :label="$t('home.branchConfig')">
                        <div v-for="(branch, index) in editingNode.branches" :key="index" class="branch-item">
                            <div class="branch-form">
                                ...
                                <el-form-item>
                                    <el-button type="danger" size="small" @click="removeEditBranch(index)">{{
                                        $t("home.deleteBranch")
                                    }}</el-button>
                                </el-form-item>
                            </div>
                        </div>
                        <el-button type="primary" size="small" @click="addEditBranch">{{ $t("home.addBranch")
                            }}</el-button>
                    </el-form-item>
                </template>
        ...
        <el-dialog v-model="showSensitivityAnalysisDialog" :title="$t('home.sensitivityAnalysisTitle')" width="700px"
            @close="clearSensitivityResults">
            <el-form :model="sensitivityAnalysisForm" label-width="120px" @submit.prevent>
                <el-form-item :label="$t('home.variableName')" required>
                    <el-input v-model="sensitivityAnalysisForm.varname"
            ...
            <div v-if="sensitivityAnalysisResult" class="dialog-results">
                ...
                <div class="result-summary">
                    ...
                    <div class="result-image-container">
                        <img :src="sensitivityAnalysisResult.file_url" :alt="$t('home.sensitivityAnalysisChart')"
                            @error="handleImageError" class="result-image" />
                    </div>

                    <div class="result-actions">
                        <el-button type="primary" size="small" @click="downloadSensitivityImage"
                            :disabled="!sensitivityAnalysisResult.file_url">
                            {{ $t("home.downloadChart") }}
                        </el-button>
                        <el-button size="small" @click="clearSensitivityResults">
            ...
            <template #footer>
                <span class="dialog-footer">
                    ...
                    <el-button type="primary" @click="performSensitivityAnalysis" :loading="sensitivityAnalysisLoading">
                        {{ $t("home.analyze") }}
                    </el-button>
                </span>
            </template>
        ...
        <!-- Risk Profile对话框 -->
        <el-dialog v-model="showRiskProfileDialog" :title="$t('home.riskProfileTitle')" width="700px"
            @close="clearRiskProfileResults">
            <el-form :model="riskProfileForm" label-width="120px">
                <el-form-item :label="$t('home.nodeIndex')" required>
                    <el-input-number v-model="riskProfileForm.idx" :min="0" :max="nodes.length - 1"
            ...
            <div v-if="riskProfileResult" class="dialog-results">
                ...
                <div class="result-summary">
                    <div class="result-info">
                        <span class="variable-name">{{ $t("home.nodeIndex") }}:
                            {{ riskProfileForm.idx }}</span>
                        <el-tag :type="riskProfileForm.cumulative
                            ? 'success'
                            : 'primary'
                            ">
                            {{
                        ...
                        <el-tag :type="riskProfileForm.single ? 'warning' : 'info'">
                            {{
                    ...
                    <div class="result-image-container">
                        <img :src="riskProfileResult.file_url" :alt="$t('home.riskProfileChart')"
                            @error="handleImageError" class="result-image" />
                    </div>

                    <div class="result-actions">
                        <el-button type="primary" size="small" @click="downloadRiskProfileImage"
                            :disabled="!riskProfileResult.file_url">
                            {{ $t("home.downloadChart") }}
                        </el-button>
                        <el-button size="small" @click="clearRiskProfileResults">
                            {{ $t("home.clearResults") }}
                        </el-button>
                    </div>
                </div>
            ...
            <template #footer>
                <span class="dialog-footer">
                    ...
                    <el-button type="primary" @click="performRiskProfileAnalysis" :loading="riskProfileLoading">
                        {{ $t("home.analyze") }}
                    </el-button>
                </span>
            </template>
        ...
        <el-dialog v-model="showPreviewDialog" :title="$t('home.preview') || 'Preview'" width="80vw" :before-close="() => {
...
// 使用当前页面的 origin 作为后端 API 基础地址（回退到 localhost:8000 以防 window 不可用）
const API_BASE = (typeof window !== "undefined" ? window.location.origin : "http://localhost:8000") + "/api";

// 如果后端返回带有固定 origin 的 file_url（例如 http://localhost:8000/output/..），
// 将其 origin 替换为当前页面的 origin，保证在不同部署环境下也能正确访问。
function normalizeFileUrl(url) {
    if (!url) return url;
    try {
        const parsed = new URL(url);
        // 仅替换 origin，保留 path/search/hash
        return (typeof window !== 'undefined' ? window.location.origin : parsed.origin) + parsed.pathname + parsed.search + parsed.hash;
    } catch (e) {
        // 如果不是绝对 URL，直接返回原值
        return url;
    }
...
const generateTree = async () => {
    ...
    try {
        ...
        // 调用API
        const response = await axios.post(`${API_BASE}/generate-tree`, requestData, {
            headers: {
...
const performSensitivityAnalysis = async () => {
    ...
    try {
        ...
        // 调用后端API
        const response = await axios.post(`${API_BASE}/sensitivity-analysis`, requestData, {
            headers: {
                "Content-Type": "application/json",
            },
        });
        ...
        if (response.data && response.data.success) {
            ...
            sensitivityAnalysisResult.value = {
                ...
                file_url: normalizeFileUrl(response.data.file_url),
            };
...
const performRiskProfileAnalysis = async () => {
    ...
    try {
        ...
        // 调用后端API
        const response = await axios.post(`${API_BASE}/risk-profile`, requestData, {
            headers: {
                "Content-Type": "application/json",
            },
        });
